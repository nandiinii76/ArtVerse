...
public class NotificationEventService {
    ...
    public void auctionPaymentReceived(UUID sellerId, UUID buyerId, String artworkTitle) { if (!same(sellerId,buyerId)) { notifications.create(sellerId,"AUCTION_PAYMENT_RECEIVED","Auction payment received","The winning payment for \""+artworkTitle+"\" has been recorded."); notifications.create(buyerId,"AUCTION_PURCHASED","Auction purchase confirmed","Your winning purchase of \""+artworkTitle+"\" is complete."); } }
    public void marketplaceOrder(UUID sellerId, UUID buyerId, String artworkTitle) { if (!same(sellerId,buyerId)) notifications.create(sellerId,"MARKETPLACE_ORDER","Artwork purchase started","Someone started an order for \""+artworkTitle+"\"."); }
    public void marketplaceOrderPaid(UUID sellerId, UUID buyerId, String artworkTitle) { if (!same(sellerId,buyerId)) { notifications.create(sellerId,"MARKETPLACE_ORDER_PAID","Artwork sold","Your artwork \""+artworkTitle+"\" has been purchased."); notifications.create(buyerId,"MARKETPLACE_PURCHASED","Purchase confirmed","Your purchase of \""+artworkTitle+"\" is complete."); } }
